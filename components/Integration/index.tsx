              ...
              <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
                  ...
                  <SectionHeader
                      headerInfo={{
                          ...
                          description: `Access and manage your property data effortlessly with our secure, cloud-based platform. Whether you’re at home, in the office, or on the go, you can keep your information up-to-date and fully synchronized from any device, anytime.`,
                      }}
                  />
